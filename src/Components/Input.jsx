...
//     if (text.trim() === '' && !img && !recordings.length && !cameraCaptureData) {
...
//   // Check if the captured data is an image or video
//   if (data.startsWith('data:image')) {
//     // If it's an image, set it as the image state
//     setImg(data);
...
//           ))}
//         </ul>
//         <img src={Img} alt="" className="camera-icon" onClick={() => setShowCamera(!showCamera)} />
